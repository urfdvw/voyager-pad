/**
 * Valid macro key codes, from guides/configure.md.
 */
...
const KEYBOARD_KEYCODES = [
    ...
    'ENTER', 'RETURN', 'ESCAPE', 'BACKSPACE', 'TAB', 'SPACEBAR', 'SPACE',
    ...
    'KEYPAD_PERIOD', 'KEYPAD_BACKSLASH',
    'APPLICATION', 'POWER', 'KEYPAD_EQUALS',
...
const MEDIA_KEYCODES = [
    'RECORD', 'FAST_FORWARD', 'REWIND',
    'SCAN_NEXT_TRACK', 'SCAN_PREVIOUS_TRACK',
    'STOP', 'EJECT', 'PLAY_PAUSE', 'MUTE',
    'VOLUME_DECREMENT', 'VOLUME_INCREMENT',
    'BRIGHTNESS_DECREMENT', 'BRIGHTNESS_INCREMENT',
];
...
const KEYCODES = [...KEYBOARD_KEYCODES, ...MEDIA_KEYCODES, ...MOUSE_KEYCODES];
const KEYCODE_SET = new Set(KEYCODES);

// Numeric key-code patterns, also handled by press_code.
const MOUSE_MOVE_PATTERN = /^MOUSE_MOVE_(-?\d+)_(-?\d+)_(-?\d+)$/;
const WAIT_PATTERN = /^WAIT_(\d+)$/;
