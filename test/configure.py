...
configure = {
    -1: { # without modifier
        ...
        5: "'Hello, World!'",
        6: "_PLAY_PAUSE", # nob
        7: "_VOLUME_INCREMENT", # clock
        8: "_VOLUME_DECREMENT", # counterclock
    },
    0: { # with modifier
...
_RECORD, _FAST_FORWARD, _REWIND, _SCAN_NEXT_TRACK, _SCAN_PREVIOUS_TRACK, _STOP, _EJECT, _PLAY_PAUSE, _MUTE, _VOLUME_DECREMENT, _VOLUME_INCREMENT, _BRIGHTNESS_DECREMENT, _BRIGHTNESS_INCREMENT
"""